...
;function ParticleSlider(a) {
    ...
    b.$controlsContainer && b.$controlsContainer.childNodes && b.showArrowControls == !0 ? (b.$controlLeft = b.$(".left", b.$controlsContainer.childNodes),
    ...
    b.imgControlNext.src = b.$controlRight.getAttribute("data-src")) : b.showArrowControls = !1,
    ...
    b.$canv.onmousemove = function(a) {
        ...
        b.mx = a.clientX - d.x + document.body.scrollLeft + document.documentElement.scrollLeft,
        b.my = a.clientY - d.y + document.body.scrollTop + document.documentElement.scrollTop
    }
    ,
    b.$canv.onmousedown = function() {
        if (b.imgs.length > 1) {
            var a = 0;
            b.mx >= 0 && b.mx < b.arrowPadding * 2 + b.$prevCanv.width ? a = -1 : b.mx > 0 && b.mx > b.cw - (b.arrowPadding * 2 + b.$nextCanv.width) && (a = 1),
            b.mouseDownRegion = a
        }
    }
    ,
    b.$canv.onmouseup = function() {
        if (b.imgs.length > 1) {
            var a = "";
            b.mx >= 0 && b.mx < b.arrowPadding * 2 + b.$prevCanv.width ? a = -1 : b.mx > 0 && b.mx > b.cw - (b.arrowPadding * 2 + b.$nextCanv.width) && (a = 1),
            a != 0 && b.mouseDownRegion != 0 && (a != b.mouseDownRegion && (a *= -1),
    ...
    if (b.imgs.length == 0)
        for (var d = 0, e = b.$$slides.length; d < e; d++) {
            var f = new Image;
            b.imgs.push(f),
            f.src = b.$$slides[d].getAttribute("data-src")
        }
...
psParticle.prototype.move = function() {
    ...
    if (this.ttl != null && this.ttl-- <= 0)
        ...
        var c = this.gravityX + a.swipeOffset - this.x
          ...
          , f = Math.atan2(d, c)
          , g = e * .01;
        a.restless == !0 ? g += Math.random() * .1 - .05 : g < .01 && (this.x = this.gravityX + .25,
        ...
        if (a.mx >= 0 && a.mouseForce) {
            ...
            i = Math.atan2(k, j),
            typeof this.color == "function" && (i += Math.PI,
            h *= .001 + Math.random() * .1 - .05)
        } else
            h = 0,
            i = 0;
...
ParticleSlider.prototype.swapList = function(a, b, c) {
    var d = this;
    a == null ? a = new d.Particle(d) : b.first == a ? a.next != null ? (a.next.prev = null,
    b.first = a.next) : b.first = null : a.next == null ? a.prev.next = null : (a.prev.next = a.next,
    a.next.prev = a.prev),
    c.first == null ? (c.first = a,
    a.prev = null,
    a.next = null) : (a.next = c.first,
    c.first.prev = a,
    c.first = a,
    a.prev = null)
}
...
ParticleSlider.prototype.parseColor = function(a) {
    ...
    if (b = /^#([\da-fA-F]{2})([\da-fA-F]{2})([\da-fA-F]{2})/.exec(a))
        ...
        b = [parseInt(b[1], 16) * 17, parseInt(b[2], 16) * 17, parseInt(b[3], 16) * 17];
...
ParticleSlider.prototype.loadingStep = function() {
    ...
    if (a.imagesLoaded >= 3 || a.showArrowControls == !1)
        a.resize(),
        a.slideDelay > 0 && (a.nextSlideTimer = setTimeout(function() {
            a.nextSlide()
        }, 1e3 * a.slideDelay))
}
,
...
ParticleSlider.prototype.nextFrame = function() {
    ...
    if (a.frame++ % 25 == 0 && (a.cw != a.getCw() || a.ch != a.getCh())) {
        var d = a.getCh()
          , e = a.getCw();
        a.ch != e && typeof a.onWidthChange == "function" && a.onWidthChange(a, e),
        a.ch != d && typeof a.onHeightChange == "function" && a.onHeightChange(a, d),
...
ParticleSlider.prototype.nextSlide = function(a) {
    var b = this;
    b.nextSlideTimer != null && b.imgs.length > 1 ? (b.currImg = (b.currImg + b.imgs.length + (a ? a : 1)) % b.imgs.length,
    b.resize(),
    b.slideDelay > 0 && (b.nextSlideTimer = setTimeout(function() {
        b.nextSlide()
...
ParticleSlider.prototype.drawParticles = function() {
    var a = this, b = a.ctx.createImageData(a.cw, a.ch), c = b.data, d, e, f, g, h, i, j = a.pxlBuffer.first;
    while (j != null) {
        e = ~~j.x,
        f = ~~j.y;
...
ParticleSlider.prototype.init = function(a) {
    ...
    if (b.imgs.length > 0) {
        ...
        for (var e = 0, f = c.length; e < f; e++) {
            var i = null;
            h != null ? (i = h,
            h = h.next) : (b.swapList(b.recycleBuffer.first, b.recycleBuffer, b.pxlBuffer),
            i = b.pxlBuffer.first),
            i.gravityX = c[e].x,
            i.gravityY = c[e].y,
            i.color = c[e].color
